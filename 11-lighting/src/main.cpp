...
int main()
{
	...
	// LIGHT CUBE (Usually we minimze shader program usage as much as possible by just updating uniforms, but not this time)
	Shader lightShader("res/shaders/lighting.vert", "res/shaders/lighting.frag");
	VAO lightVAO;
	lightVAO.Bind();
	...
	lightShader.Bind();
	glUniform4f(glGetUniformLocation(lightShader.ID, "lightColor"), 1.0f, 1.0f, 1.0f, 1.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightShader.Bind();
		camera.setMatrix(45.0f, 0.1f, 100.0f, lightShader, "camMatrix");
		lightVAO.Bind();
