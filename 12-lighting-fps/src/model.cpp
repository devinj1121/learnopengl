...
void Model::setMatrix(Shader& shader, glm::mat4 matrix, const char* uniform){
...
Mesh Model::buildMesh(aiMesh *mesh, const aiScene *scene)
{
    ...
    // Walk through faces to pick up indices (i.e., build indices buffer)
    ...
    // Process material of this mesh (meshes just have pointers to material, which is held by scene object)
