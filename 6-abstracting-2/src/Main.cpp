...
int main()
{
	...
	VAO VAO1; 
	VAO1.Bind();
	VBO VBO1(vertices, sizeof(vertices)); // generate and bind to curr VAO
	EBO EBO1(indices, sizeof(indices)); // generate and bind to curr VAO

	// Defines and links VBO attributes to VAO
